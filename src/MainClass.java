...
//            for(Pair<int[], Color> p : list) {
//                g.setColor(p.getValue());
//                g.drawLine(p.getKey()[0], p.getKey()[1], p.getKey()[2], p.getKey()[3]);
//            }
    ...
    private Color color;
    private LinkedList<Pair<int[], Color>> list;
...
//                graphics = label.getGraphics();
//                graphics.setColor(color);
//                graphics.drawLine(e.getX(), e.getY(), e.getX(), e.getY());
//                graphics.dispose();
//                list.addLast(new Pair<>(new int[]{e.getX(), e.getY(), e.getX(), e.getY()}, color));
...
//                graphics = label.getGraphics();
//                graphics.setColor(color);
//                graphics.drawLine(prevPoint.x, prevPoint.y, e.getX(), e.getY());
//                graphics.dispose();
//                list.addLast(new Pair<>(new int[]{prevPoint.x, prevPoint.y, e.getX(), e.getY()}, color));
//                prevPoint = currPoint;
//                currPoint.x = e.getX();
//                currPoint.y = e.getY();
                prevPoint = currPoint;
